...
const LIGHT_TOKENS = {
  ...
  '--dsw-alias-brand-primary': '#58a6c8',
  '--dsw-alias-brand-text': '#fffdf4',
  '--dsw-alias-button-primary-hover': '#4a94b8',
  ...
  '--dsw-alias-state-business-primary': '#58a6c8',
  ...
  '--dsw-alias-interactive-bg-hover': 'rgba(88, 166, 200, 0.12)',
  '--dsw-alias-interactive-bg-active': 'rgba(88, 166, 200, 0.22)',
  '--dsw-alias-interactive-bg-hover-accent': 'rgba(88, 166, 200, 0.18)',
  ...
  '--dsw-specific-sidebar-nav-item-active-accent': 'rgba(88, 166, 200, 0.25)',
  ...
  '--dsw-alias-separator-primary': 'rgba(88, 166, 200, 0.35)',
  ...
  '--dsw-alias-brand-primary-new-colorprimary-new-color': '#58a6c8',
  '--dsw-alias-button-contrast-fill': '#3a5a6a',
  '--dsw-alias-button-info-fill': '#58a6c8',
  '--dsw-alias-button-info-hover': '#7ab8cc',
  '--dsw-alias-button-primary-fill': '#58a6c8',
...
const DARK_TOKENS = {
  ...
  '--dsw-alias-state-warn-primary': '#c29b38',
  '--dsw-alias-state-warn-secondary': '#c29b38',
